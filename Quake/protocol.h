...
#define U_STEPMOVE		(1<<21) // [Standalone] 3 coords, passes how much the entity moved from steps that frame.
...
#define SU_CROUCH		(1<<26) // [Standalone] 1 coord, tracks the z offset from walking on stairs.
